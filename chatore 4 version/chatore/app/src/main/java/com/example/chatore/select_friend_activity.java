...
public class select_friend_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressBar= findViewById(R.id.progressBar_select_friend);
                ...
                for(DataSnapshot ds : snapshot.getChildren())
                {
                    ...
                    databaseReferenceUsers.child(userId).addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onCancelled(@NonNull DatabaseError error) {
                            Toast.makeText(select_friend_activity.this, getString(R.string.failed_to_fetch_friend,error.getMessage()), Toast.LENGTH_SHORT).show();
                        }
                    });
                }
